...
class Heroku {
  ...
  request (options) {
    var Request = __nccwpck_require__(791)
    options = options || {}
...
function debugHeaders () {
  try {
    if (!_debugHeaders) _debugHeaders = __nccwpck_require__(237)('http')
...
function debug () {
  try {
    if (!_debug) _debug = __nccwpck_require__(237)('http')
...
class Request {
  constructor (options) {
    ...
    if (!this.userAgent) {
      var pjson = __nccwpck_require__(292)
...
var net = __nccwpck_require__(808)
  ...
  , Buffer = (__nccwpck_require__(867).Buffer)
  ;
